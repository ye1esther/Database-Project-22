...
<?php
	...
	echo "<h2> What are the titles of a Netflix movie with the longest duration that was released in the given year?</h2><br>";
	...
	if (empty($year)) {
		...
		if ($stmt = $conn->prepare("CALL Query_9(?)")) {
		...
		if ($stmt->execute()) {
			...
			if (($result) && ($result->num_rows != 0)) {
				...
				echo "<tr><th> The Titles of Movies </th><th> Duration (min) </th></tr>";
