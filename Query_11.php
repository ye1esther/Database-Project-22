...
<?php
	...
	echo "<h2>How many movies were released in 2020 that were produced in the given country?</h2><br>";
	...
	if (empty($country)) {
		...
		if ($stmt = $conn->prepare("CALL Query_11(?)")) {
		...
		if ($stmt->execute()) {
			...
			if (($result) && ($result->num_rows != 0)) {
				...
				echo "<tr><th> The Number of Movies </th></tr>";
