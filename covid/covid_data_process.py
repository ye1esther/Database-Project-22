...
covid = pd.read_csv(os.path.join(os.path.dirname(__file__), "../dataset/covid_data.csv"))

# list of columns we want to drop 
to_drop = ['total_deaths','new_cases_per_million', 'total_cases_per_million','iso_code', 'continent', 'new_cases_smoothed', 'new_deaths_smoothed', 'new_deaths', 'new_cases_smoothed_per_million', 'total_deaths_per_million',
...
'total_tests','new_tests', 'total_tests_per_thousand', 'new_tests_per_thousand', 'new_tests_smoothed','new_tests_smoothed_per_thousand','tests_per_case',
'positive_rate', 'tests_units', 'stringency_index', 'population', 'population_density', 'median_age', 'aged_65_older', 'aged_70_older', 'gdp_per_capita', 'extreme_poverty',
'cardiovasc_death_rate', 'diabetes_prevalence', 'female_smokers',  'male_smokers', 'handwashing_facilities', 'hospital_beds_per_thousand', 'life_expectancy', 'human_development_index' ]

covid.drop(to_drop, inplace = True, axis=1)

# rename columns 
covid_rename = {'location': 'country', 
