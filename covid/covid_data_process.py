...
to_drop = ['iso_code', 'continent', 'new_cases_smoothed', 'total_deaths', 'total_cases_per_million', 'new_cases_smoothed_per_million', 
...
# rename columns 
covid_rename = {'last_updated_date': 'date',  'location': 'country', 
